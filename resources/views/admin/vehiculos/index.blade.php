                ...
                @foreach($vehiculos as $v)
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('admin.vehiculos.edit', $v->id) }}" class="btn btn-primary btn-sm">Editar</a>

                            <form action="{{ route('admin.vehiculos.delete', $v->id) }}" method="POST" style="display:inline;">
                                @csrf @method('DELETE')
