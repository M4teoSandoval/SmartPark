                ...
                <form method="POST" action="{{ route('admin.movimientos.entrada') }}">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="placa" class="form-control @error('placa') is-invalid @enderror" placeholder="Ej: ABC123" required>
                            @error('placa')
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="tipo_vehiculo" class="form-control @error('tipo_vehiculo') is-invalid @enderror" required>
